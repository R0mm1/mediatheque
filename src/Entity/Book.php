...
#[ORM\DiscriminatorMap(['electronicbook' => '\App\Entity\Book\ElectronicBook\Book', 'paperbook' => '\App\Entity\Book\PaperBook\Book', 'audiobook' => '\App\Entity\Book\AudioBook\Book'])]
class Book extends AbstractEntity
{
     ...
     * @var File|null
     */
    #[ORM\ManyToOne(targetEntity: \App\Entity\Book\Cover::class, cascade: ['persist'])]
     ...
     */
    #[ORM\ManyToMany(targetEntity: \App\Entity\Book\ReferenceGroup::class, mappedBy: 'books')]
    private $groups;

    /**
     * @var Collection
     */
    #[ORM\OneToMany(targetEntity: \App\Entity\Book\ReferenceGroup\Book::class, mappedBy: 'book')]
    #[Groups(['book:get'])]
    private Collection $groupMemberships;

    #[ORM\ManyToOne(targetEntity: \App\Entity\User::class, inversedBy: 'books')]
    #[Groups(['book:get', 'book:set'])]
    private $owner;

    #[ORM\ManyToOne(targetEntity: \App\Entity\Editor::class)]
    #[Groups(['book:get', 'book:set'])]
